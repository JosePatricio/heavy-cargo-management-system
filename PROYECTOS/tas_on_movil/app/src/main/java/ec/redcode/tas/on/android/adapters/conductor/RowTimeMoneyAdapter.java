...
public class RowTimeMoneyAdapter extends RecyclerView.Adapter<RowTimeMoneyAdapter.ViewHolder> {

    private List<FleteShort> mValues;
    private ClickListener clickListener;

    public RowTimeMoneyAdapter(List<FleteShort> items, ClickListener clickListener) {
        mValues = items;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_flete_time_money, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mMoney.setText(String.valueOf(mValues.get(position).getAmount())+"$");
        //long timeLeft = mValues.get(position).getDeliveryDate() - System.currentTimeMillis();
        holder.mTimeLimit.setText(mValues.get(position).getDays() + "d" );
