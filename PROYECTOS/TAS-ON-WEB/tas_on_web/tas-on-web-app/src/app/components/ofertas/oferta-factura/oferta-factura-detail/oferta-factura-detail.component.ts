...
@Component({
  selector: 'app-oferta-factura-detail',
  templateUrl: './oferta-factura-detail.component.html',
  styleUrls: ['./oferta-factura-detail.component.css']
})
export class OfertaFacturaDetailComponent implements OnInit {
