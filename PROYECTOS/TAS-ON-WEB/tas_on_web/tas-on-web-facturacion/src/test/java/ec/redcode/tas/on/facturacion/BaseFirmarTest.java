...
public class BaseFirmarTest {
    ...
    public String createXML() throws JAXBException {
        ...
        totalImpuestos.add(totalImpuesto);
        totalConImpuestos.getTotalImpuesto().addAll(totalImpuestos);
        ...
        detAdicionalList.add(detAdicional);
        detallesAdicionales.getDetAdicional().addAll(detAdicionalList);
        detalle.setDetallesAdicionales(detallesAdicionales);
        List<Detalle> detalleList = new ArrayList<>();
        detalleList.add(detalle);
        detalles.getDetalle().addAll(detalleList);
