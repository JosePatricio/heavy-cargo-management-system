...
import {SolicitudItem, Loader,Line,InputText,Text ,Icon as Icono} from '../../components/';
...
class AprobadasScreen extends Component {
  ...
  makeOffer = async values => {
    try {
      const response = await this.props.dispatch(
        sendMyOffer(JSON.stringify(values), this.state.user)
      );
  ...
  render() {
    ...
    this.state.isLoading =
      this.props.solicitudService.getByIdReducer.isFetching ||
      this.props.solicitudService.makeOffertReducer.isFetching;
        ...
        <ScrollView>
          <View style={styles.container}>
            ...
            >
              ...
              <AwesomeButtonRick height={50} stretch={true} style={style.defaultButton} onPress={handleSubmit(this.ofertar)} backgroundColor={defaultTasonColor}><Text style={style.defaultTextButton}>Guardar</Text></AwesomeButtonRick>
